...
# of log(0.12/0.88)
# The chosen randomization method is the MPBD
...
tlr.post.prob = tlr.logit.post.prob(model = "tlr", n=c(28,17), y=c(10,4),  m0=c(log(0.12/0.88),0))

#determine randomization schedule
group.rand.schedule = rand.schedule(post.prob = tlr.post.prob, rand.type=c("Block"))
